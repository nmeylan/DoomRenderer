...
(function() {
  var DIRECTORY_LUMP_ENTRY_SIZE, LUMP_NAMES, LumpInfo, NUMBER_PALETTES, Palette, Playpal, ctx;
  ...
  ctx.Wad = (function() {
    ...
    Wad.prototype.read = function(data) {
      ...
      this.readHeader();
      return this.playpall = new Playpal(this.lumpHash["PLAYPAL"].getByteData(this.data));
    };
